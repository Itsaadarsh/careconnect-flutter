...
class RealtimeChart3 extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return RealtimeChart3State();
  }
}

class RealtimeChart3State extends State<RealtimeChart3>
  ...
  void initState() {
    ...
    _streamSubscription = _dataStream.listen((dataSet) {
      var rng = new Random();
      // print("-==-----------");
      // print(rng.nextInt(150));
      setState(() {
        value = rng.nextInt(50);
      });
      print("dataSet: ${value.toString()}");
      addEntry(value.toDouble(), value.toDouble());
    });
    super.initState();
  }
