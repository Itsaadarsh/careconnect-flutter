...
router.get("/data", auth_1.default, (_, res) => __awaiter(void 0, void 0, void 0, function* () {
    const rand = (yield Math.floor(Math.random() * (200471 - 10))) + 10;
    const vitals = yield vitals_1.default.find().skip(rand).limit(1);
    if (vitals === null)
